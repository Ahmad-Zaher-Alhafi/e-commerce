      ...
      <div className={"flex flex-col sm:flex-row gap-[24px] sm:gap-[113px]"}>
        <div className={"flex flex-col gap-[5px] sm:w-[248px]"}>
          ...
          <div className={"flex gap-[12px] pt-[15px]"}>
            <Image src="/assets/svgs/twitterIcon.svg" alt="twitter icon" />
            <Image src="/assets/svgs/facebookIcon.svg" alt="facebook icon" />
            <Image src="/assets/svgs/instagramIcon.svg" alt="instagram icon" />
            <Image src="/assets/svgs/girhubIcon.svg" alt="girhub icon" />
          </div>
        </div>
      ...
      <div className={"flex flex-col gap-[16px]"}>
        ...
        >
          ...
          <div className={"flex gap-[10px]"}>
            <Image src="/assets/svgs/visaCard.svg" alt="visa car image" />
            <Image src="/assets/svgs/masterCard.svg" alt="master card image" />
            <Image src="/assets/svgs/paypalCard.svg" alt="paypal card image" />
            <Image
