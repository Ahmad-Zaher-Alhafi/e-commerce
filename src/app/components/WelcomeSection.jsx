    ...
    return (
        <section className={"relative"}>
            ...
            <div
                ...
                <p className={"font-satoshi text-[clamp(14px,1.5vw,8rem)] opacity-[60%]"}>
                ...
                <div className={"flex justify-center gap-[27px] flex-wrap px-[28px] sm:px-0"}>
                    <div className={"flex flex-col flex-1 sm:gap-2.5"}>
                        <span className={"font-satoshi font-bold text-2xl xl:text-[40px]"}>200+</span>
                        <span
                            className={"font-satoshi text-xs opacity-60  xl:text-[16px]"}>International Brands</span>
                    </div>

                    <div className={"bg-black opacity-[10%] w-[1px]"}></div>

                    <div className={"flex flex-col flex-1 sm:gap-2.5"}>
                        <span className={"font-satoshi font-bold text-2xl  xl:text-[40px] "}>2,000+</span>
                        <span
                            className={"font-satoshi text-xs opacity-60  xl:text-[16px]"}>High-Quality Products</span>
                    </div>

                    <div className={"bg-black opacity-[10%] w-[1px] hidden xs:block"}></div>

                    <div className={"flex flex-col sm:gap-2.5"}>
                        <span className={"font-satoshi font-bold text-2xl  xl:text-[40px]"}>30,000+</span>
                        <span className={"font-satoshi text-xs opacity-60  xl:text-[16px]"}>Happy Customers</span>
                    </div>
                </div>
            </div>
            ...
            <div className={"flex justify-center bg-[#F2F0F1] relative"}>
                <picture className={"relative"}>
                    ...
                    <source srcSet="/assets/images/mainImage.png" media="(min-width: 1021px)"/>
                    <source srcSet="/assets/images/mainImageSmall.png" media="(max-width: 1024px)"/>
                    <img src="/assets/images/mainImageSmall.png" alt="Main Image"/>

                    <div>
                        <img
                            className={"absolute top-1/3 left-10 right-0 lg:left-1/2 lg:right-1/2 transform -translate-y-[30px] lg:translate-x-20"}
