...
const WelcomeSection = () => {
  return (
    <section className={"relative"}>
      ...
      >
        <Image src="/assets/svgs/versLogo.svg" alt="versace image" />
        <Image src="/assets/svgs/zaraLogo.svg" alt="zara image" />
        <Image src="/assets/svgs/gucciLogo.svg" alt="gucci image" />
        <Image src="/assets/svgs/pradaLogo.svg" alt="prada image" />
        <Image src="/assets/svgs/calvinLogo.svg" alt="calvin klein image" />
      </div>
    </section>
  );
};
